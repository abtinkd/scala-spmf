...
class RecursionCloSpan {
     ...
     */
    public RecursionCloSpan(AbstractionCreator abstractionCreator, Saver saver, long minSupport, PseudoSequenceDatabase pseudoDatabase, Map<Item, BitSet> mapSequenceID, boolean findClosedPatterns, boolean executePruningMethods) {
    ...
    private void cloSpanLoop(Pattern prefix, TrieNode prefixNode, int k, PseudoSequenceDatabase context, boolean verbose) {
         ...
         */
        if (context == null || context.size() < minSupport) {
            return;
        }
