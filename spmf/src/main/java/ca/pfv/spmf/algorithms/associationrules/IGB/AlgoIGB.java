...
public class AlgoIGB {
    ...
    private void processItemset(Itemset i) throws IOException {
        ...
        if (i.getRelativeSupport(databaseSize) >= minconf) {  // line 3
            ...
            Rule rule = new Rule(new Itemset(), i, i.getAbsoluteSupport(), i.getRelativeSupport(databaseSize)); // 4,5,6
            save(rule);
            return;
        }
    ...
    private void save(Rule rule) throws IOException {
        ...
        if (writer != null) {
            ...
            buffer.append(" #SUP: ");
            // write support
            buffer.append(doubleToString(rule.getRelativeSupport(databaseSize)));
            // write separator
            buffer.append(" #CONF: ");
            // write confidence
