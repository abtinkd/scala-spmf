...
public class AlgoPrefixSpan_AGP {
     ...
     */
    public AlgoPrefixSpan_AGP(double support, AbstractionCreator creator) {
        this.minSup = support;
    ...
    protected void prefixSpan(SequenceDatabase database, boolean keepPatterns, boolean verbose, String outputFilePath) throws IOException {
        ...
        RecursionPrefixSpan_AGP algorithm = new RecursionPrefixSpan_AGP(abstractionCreator, saver, (int) relativeMinSupport, pseudoDatabase, mapSequenceID);
