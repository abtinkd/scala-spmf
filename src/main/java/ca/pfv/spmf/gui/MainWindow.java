...
public class MainWindow extends JFrame {
    ...
    public static String SPMF_VERSION = "0.94c";
    // current input file
...
//		System.out.println("Command " + Arrays.toString(args));
        ...
        // the command line.
        if (args.length != 0) {
            commandLine(args); // process command line arguments.
        } else {
            ...
            public void itemStateChanged(ItemEvent evt) {
                ...
                if (evt.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if ("SPAM".equals(evt.getItem())
                            ...
                            || "PrefixSpan_AGP".equals(evt.getItem())
                            || "PrefixSpan_PostProcessingClosed".equals(evt.getItem())
                            || "GSP".equals(evt.getItem())
                            || "SPADE".equals(evt.getItem())
                            || "SPADE_Parallelized".equals(evt.getItem())
                            || "SPAM_AGP".equals(evt.getItem())
                            || "SPAM_PostProcessingClosed".equals(evt.getItem())
                            || "ClaSP".equals(evt.getItem())
                            || "CloSpan".equals(evt.getItem())) {
                    ...
                    } else if ("HirateYamana".equals(evt.getItem())
                            || "Fournier08-Closed+time".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                    ...
                    //							"Fournier08-Closed+time+valued_items".equals(evt.getItem()))
                    //					{
                    //						// show the parameters of this algorithm
                    //						hideAllParams(); 
                    //						setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                    ...
                    //					comboBox.addItem("Fournier08-Closed+time");
                    //					comboBox.addItem("Fournier08-Closed+time+valued_items");
                    else if ("SeqDim_(PrefixSpan+Apriori)".equals(evt.getItem())
                            || "SeqDim_(BIDE+AprioriClose)".equals(evt.getItem())
                            || "SeqDim_(BIDE+Charm)".equals(evt.getItem())
                            || "PrefixSpan_with_strings".equals(evt.getItem())
                            || "BIDE+".equals(evt.getItem())
                            || "BIDE+_with_strings".equals(evt.getItem())
                            || "FPGrowth_itemsets".equals(evt.getItem())
                            || "FPGrowth_itemsets_with_strings".equals(evt.getItem())
                            || "Apriori".equals(evt.getItem())
                            || "Apriori_TID_bitset".equals(evt.getItem())
                            || "Apriori_TID".equals(evt.getItem())
                            || "Apriori_TIDClose".equals(evt.getItem())
                            || "AprioriClose".equals(evt.getItem())
                            || "AprioriRare".equals(evt.getItem())
                            || "Eclat".equals(evt.getItem())
                            || "Charm".equals(evt.getItem())
                            || "Charm_MFI".equals(evt.getItem())
                    ...
                    } else if ("Apriori_with_hash_tree".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.4 or 40%)");
                        setParam(textFieldParam2, "Hash-tree branch count:", labelParam2, "(default: 30)");
                    } else if ("SeqDim_(PrefixSpan+Apriori)+time".equals(evt.getItem())
                            || "SeqDim_(BIDE+AprioriClose)+time".equals(evt.getItem())
                            || "SeqDim_(BIDE+Charm)+time".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g.  0.5  or 50 %)");
                    ...
                    } else if ("FPGrowth_association_rules".equals(evt.getItem())
                            || "Apriori_association_rules".equals(evt.getItem())
                            || "RuleGrowth".equals(evt.getItem())
                            || "CMRules".equals(evt.getItem())
                            || "CMDeo".equals(evt.getItem())
                            || "IGB".equals(evt.getItem())
                            || "Closed_association_rules".equals(evt.getItem())
                            || "MNR".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                        setParam(textFieldParam2, "Choose minconf (%):", labelParam2, "(e.g. 0.6 or 60%)");
                    }//
                    else if ("Sporadic_association_rules".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    } else if ("Indirect_association_rules".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    } else if ("Hierarchical_clustering".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose max distance:", labelParam1, "(e.g. 4)");
                    } else if ("FPGrowth_association_rules_with_lift".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                        setParam(textFieldParam2, "Choose minconf (%):", labelParam2, "(e.g. 0.6 or 60%)");
                    ...
                    } else if ("TNR".equals(evt.getItem()) || "TNS".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    } else if ("HUI-Miner".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 30)");
                    } else if ("FHSAR".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                        setParam(textFieldParam2, "Choose minconf (%):", labelParam2, "(e.g. 0.6 or 60%)");
                        ...
                        setParam(textFieldParam1, "MIS file name:", labelParam1, "(e.g. MIS.txt)");
                            ...
                            || "TRuleGrowth_with_strings".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    } else if ("Convert_a_sequence_database_to_SPMF_format".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    else if ("Convert_a_transaction_database_to_SPMF_format".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        setParam(textFieldParam1, "Choose input format:", labelParam1, "(e.g. CSV_INTEGER)");
                        setParam(textFieldParam2, "Choose sequence count:", labelParam2, "(e.g. 5)");
                    } else if ("Generate_a_sequence_database".equals(evt.getItem())
                            || "Generate_a_sequence_database_with_timestamps".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                    ...
                    } else if ("Generate_a_transaction_database".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
                        ...
                        buttonInput.setVisible(false);
                        textFieldInput.setVisible(false);
                    } else if ("Calculate_stats_for_a_sequence_database".equals(evt.getItem())) {
                        // show the parameters of this algorithm
                        hideAllParams();
...
//				contextMDDatabase.printContext();
                ...
                /////////////////////////////////////////////////////////////beginning adding by Antonio Gomariz//////////////////////////////////////////////////////////
...
//				database.printDatabase();
                ...
                Itemsets patterns = aclose.runAlgorithm(database, minsup, null);
                ...
                ClosedRules rules = algoAgrawal.runAlgorithm(patterns, minconf, outputFile);
            } // IGB
            ...
            } else if ("HierarchicalClustering".equals(algorithmName)) {
...
//				database.printDatabase();
                ...
                algo.runAlgorithm(outputFile, database, 100000, minsup, false);
                algo.printStats();
                ...
                algo.runAlgorithm(outputFile, database, minsup, false);
                algo.printStats();
