...
/**
 * This is the Philippe Fournier-Viger implementation of the PrefixSpan algorithm.
 * PrefixSpan was proposed by Pei et al. 2001.
 * <br/><br/>
 * <p/>
 * Han, J., Pei, J., Mortazavi-Asl, B., Pinto, H., Chen, Q., Dayal, U., & Hsu, M. C. (2001, April).
 * Prefixspan: Mining sequential patterns efficiently by prefix-projected pattern growth.
 * In proceedings of the 17th international conference on data engineering (pp. 215-224).
 * <br/><br/>
 * <p/>
...
public class AlgoPrefixSpan {
     ...
     */
    public SequentialPatterns runAlgorithm(SequenceDatabase database, double minsupPercent, String outputFilePath) throws IOException {
