...
public class AlgoSPAM_AGP {
     ...
     */
    public AlgoSPAM_AGP(double support) {
        this.minSup = support;
    }
    ...
    public void runAlgorithm(SequenceDatabase database, boolean keepPatterns, boolean verbose, String outputFilePath) throws IOException {
        ...
        runSPAM(database, (long) minSupRelative, keepPatterns, verbose);
     ...
     * @param verbose         Flag for debugging purposes
     */
    protected void runSPAM(SequenceDatabase database, long minSupportCount, boolean keepPatterns, boolean verbose) {
        ...
        FrequentPatternEnumeration_SPAM frequentPatternEnumeration = new FrequentPatternEnumeration_SPAM(minSupRelative, saver);
