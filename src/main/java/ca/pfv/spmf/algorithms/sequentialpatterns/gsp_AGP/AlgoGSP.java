...
public class AlgoGSP {
    ...
    /**
     * Minimum relative support threshold. It indicates the minimum number of
     ...
     * attributes.
     */
    public AlgoGSP(double support, double mingap, double maxgap, double windowSize, AbstractionCreator abstractionCreator) {
        this.minSup = support;
        this.minGap = mingap;
        this.maxGap = maxgap;
    ...
    protected void runGsp(SequenceDatabase database, CandidateGeneration candidateGenerator, SupportCounting supportCounter, boolean keepPatterns, boolean verbose) throws IOException {
        ...
        */
        ...
        while (frequentSet != null && !frequentSet.isEmpty()) {
            ...
            candidateSet = candidateGenerator.generateCandidates(frequentSet, abstractionCreator, indexationMap, k, minSupRelative);
            frequentSet = null;
            ...
            frequentSet = supportCounter.countSupport(candidateSet, k, minSupRelative);
            if (verbose) {
    ...
    /**
     * Return the minimum relative support, i.e. the minimum number of sequences
