...
class SupportCounting {
     ...
     * @param minSupport   the minimum relative support, i.e. the minimum number of
     *                     sequences where a candidate have to appear
     * @return the set of frequent patterns.
     */
    public Set<Pattern> countSupport(List<Pattern> candidateSet, int k, double minSupport) {
        indexationMap.clear();
