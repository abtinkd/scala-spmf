...
/**
 * This class represents a set of itemsets where itemsets are a list of integers with a
 * transaction id set represented by a list of integer. In this set, itemsets are ordered by size. For
