...
/**
 * This class represents a set of itemsets that are ordered by size (level) and where
 * an itemset is a list of integers with a support count. For
